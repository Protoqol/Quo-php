...
abstract class AbstractCloner implements ClonerInterface
{
    public static $defaultCasters = [
        ...
        'Doctrine\Common\Proxy\Proxy'               => [
            'Protoqol\Quo\VarDumper\Caster\DoctrineCaster',
            'castCommonProxy',
        ],
        ...
        'ErrorException'                                           => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
            'castErrorException',
        ],
        'Exception'                                                => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
        ...
        'Symfony\Bridge\Monolog\Logger'                            => [
            'Protoqol\Quo\VarDumper\Caster\StubCaster',
            'cutInternals',
        ],
        'Protoqol\Quo\DependencyInjection\ContainerInterface'      => [
            'Protoqol\Quo\VarDumper\Caster\StubCaster',
            'cutInternals',
        ],
        'Protoqol\Quo\EventDispatcher\EventDispatcherInterface'    => [
            'Protoqol\Quo\VarDumper\Caster\StubCaster',
            'cutInternals',
        ],
        'Protoqol\Quo\HttpClient\AmpHttpClient'                    => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClient',
        ],
        'Protoqol\Quo\HttpClient\CurlHttpClient'                   => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClient',
        ],
        'Protoqol\Quo\HttpClient\NativeHttpClient'                 => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClient',
        ],
        'Protoqol\Quo\HttpClient\Response\AmpResponse'             => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClientResponse',
        ],
        'Protoqol\Quo\HttpClient\Response\CurlResponse'            => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClientResponse',
        ],
        'Protoqol\Quo\HttpClient\Response\NativeResponse'          => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castHttpClientResponse',
        ],
        'Protoqol\Quo\HttpFoundation\Request'                      => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castRequest',
        ],
        'Protoqol\Quo\Uid\Ulid'                                    => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castUlid',
        ],
        'Protoqol\Quo\Uid\Uuid'                                    => [
            'Protoqol\Quo\VarDumper\Caster\SymfonyCaster',
            'castUuid',
        ],
        'Protoqol\Quo\VarDumper\Exception\ThrowingCasterException' => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
            'castThrowingCasterException',
        ],
        'Protoqol\Quo\VarDumper\Caster\TraceStub'                  => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
            'castTraceStub',
        ],
        'Protoqol\Quo\VarDumper\Caster\FrameStub'                  => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
            'castFrameStub',
        ],
        'Protoqol\Quo\VarDumper\Cloner\AbstractCloner'             => [
            'Protoqol\Quo\VarDumper\Caster\StubCaster',
            'cutInternals',
        ],
        'Protoqol\Quo\ErrorHandler\Exception\SilencedErrorContext' => [
            'Protoqol\Quo\VarDumper\Caster\ExceptionCaster',
        ...
        'ProxyManager\Proxy\ProxyInterface'          => [
            'Protoqol\Quo\VarDumper\Caster\ProxyManagerCaster',
            'castProxy',
        ],
    ...
    protected function castObject(Stub $stub, bool $isNested)
    {
        ...
        try {
            ...
            $a = [
                    (Stub::TYPE_OBJECT === $stub->type ? Caster::PREFIX_VIRTUAL : '') . '⚠' => new ThrowingCasterException(
                        $e
                    ),
                ] + $a;
        }
